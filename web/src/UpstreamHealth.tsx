...
const resultCopy: Record<string, { title: string; detail: string; tone: 'active' | 'warning' | 'danger' }> = {
  ...
  authentication_failed: { title: '上游拒绝当前凭据', detail: '请核对凭据或使用已有的重新授权流程。', tone: 'danger' },
  ...
  configuration_changed: { title: '账号配置已变化', detail: '本次结果未应用到新版本，请刷新列表后重新检查。', tone: 'warning' },
