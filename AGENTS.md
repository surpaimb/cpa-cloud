...
This is a new independent implementation, currently in planning. Read docs/product-plan.md and docs/independent-implementation.md before implementation.
...
- Target single-tenant internal company use, headless Linux deployment, a browser admin console, and standard API access with per-employee keys. No WeChat/Gate dependency or mandatory desktop client.
