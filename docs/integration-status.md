...
- `main` 基线 `481f8b788aba2b2f159808b2ddabe8f09eaa526a` 已包含 PR #4 的恢复材料、双版本恢复路径与合成跨机验证，PR #5 的管理员余额/日月结算/CSV 与计费网页，以及 PR #6 的 Chat↔Responses、Messages↔Responses、Gemini↔Responses 六个非流式显式 wire 方向。它们不代表真实第二环境灾备、员工自助门户、生产支付或真实供应商兼容性已经验收。
