...
状态：**源码及本批合成验收已完成**。截至 2026-09-23，四协议的账号预检、一次安全切换、租约和实际账号账本已接入；公共协调器、隔离真实 Go 进程、完整 Go 测试及 Linux race 通过，证据见[集成状态](integration-status.md)。不包含在 preview.3 安装包中，未验证真实供应商账号。
